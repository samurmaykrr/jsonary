import { X, Plus, FileJs, Copy, Files, XCircle } from '@phosphor-icons/react';
import { cn } from '@/lib/utils';
import { useTabs, useDocumentActions } from '@/store/documentStore';
...
export function TabBar() {
  const tabs = useTabs();
  const { createDocument, closeDocument, setActive, reorderTabs, duplicateDocument } = useDocumentActions();
  ...
  }, [tabs, closeDocument, duplicateDocument, openMenu]);
